...
@section('content')
        ...
        <div class="slider-area ">
            ...
            <div class="slider-active dot-style">
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="{{asset('assets/img/hero/h2_hero.jpg')}}" >
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">More na dlanu</h1>
                                    <h3 data-animation="fadeInDown" data-delay=".4s">Apartmani uz samu obalu</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="{{asset('assets/img/hero/h3_hero.jpg')}}" >
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">Terasa stvorena za opuštanje</h1>
                                    <h3 data-animation="fadeInDown" data-delay=".4s">Jutarnja kava i večeri uz zalazak sunca</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="single-slider  hero-overly slider-height d-flex align-items-center" data-background="{{asset('assets/img/hero/h4_hero.jpg')}}" >
                    <div class="container">
                        <div class="row justify-content-center text-center">
                            <div class="col-xl-9">
                                <div class="h1-slider-caption">
                                    <h1 data-animation="fadeInUp" data-delay=".4s">Komfor od dolaska do odlaska</h1>
                                    <h3 data-animation="fadeInDown" data-delay=".4s">Parkirajte i uživajte u pogledu</h3>
                                </div>
                            </div>
                        </div>
                    </div>
               ...
               <div class="col-12">
                ...
                <div class="booking-wrap d-flex justify-content-between align-items-center">
                    ...
                    <div class="single-select-box pt-45 mb-30">
                        <a href="#" class="btn select-btn">Rezerviraj</a>
                   </div>
            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-xl-8">
                        ...
                        <div class="font-back-tittle mb-45">
                            ...
                            <h3 class="archivment-back">Naše sobe</h3>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row justify-content-center">
                    <div class="room-btn pt-70 pb-70">
                        <a href="#" class="btn view-btn1">Vidi više  <i class="ti-angle-right"></i> </a>
                    </div>
                </div>
            </div>
